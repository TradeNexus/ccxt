...
* jsDelivr: https://cdn.jsdelivr.net/npm/ccxt@1.42.18.1/dist/ccxt.browser.js
* unpkg: https://unpkg.com/ccxt@1.42.18.1/dist/ccxt.browser.js
...
```HTML
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/ccxt@1.42.18.1/dist/ccxt.browser.js"></script>
```
